...
HLS_SOURCES = ../../../testbench.cpp ../../../tetrissolver.cpp
...
$(ObjDir)/tetrissolver.o: ../../../tetrissolver.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../tetrissolver.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/tetrissolver.d
